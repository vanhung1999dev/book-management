...
const list_permision = [
    ...
    { path: "^DELETE,/books/[0-9]+$", id_permision: 15 },

    //catelog permision
    { path: "^POST,/catelogs$", id_permision: 16 },
    { path: "^GET,/catelogs/[0-9]+$", id_permision: 17 },
    { path: "^GET,/catelogs$", id_permision: 18 },
    { path: "^PUT,/catelogs/[0-9]+$", id_permision: 19 },
    { path: "^DELETE,/catelogs/[0-9]+$", id_permision: 20 },

    //account permision
    { path: "^POST,/accounts$", id_permision: 21 },
    { path: "^GET,/accounts/[0-9]+$$", id_permision: 22 },
    { path: "^GET,/accounts$", id_permision: 23 },
    { path: "^PUT,/accounts/[0-9]+$$", id_permision: 24 },
